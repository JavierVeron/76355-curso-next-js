    ...
    return (
        <div className="container m-auto flex flex-col my-20">
            ...
            <table>
                <tbody>
                    <tr>
                        <td colSpan={6} className="px-6 py-4 text-end"><Boton onClick={clearCart}>Vaciar Carrito</Boton></td>
                    </tr>
                    {
                        cart.map(item => (
                            <tr key={item.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                ...
                                <td className="px-6 py-4 text-end"><Boton onClick={() => {deleteItem(item.id)}}>Eliminar</Boton></td>
                            </tr>
                        ))
                    }
                    <tr>
